...
process INDEX() {
    ...
    '''
        ...
        star_genome_indexing() {
            ...
            local num_of_threads=40
            local index_command="${star_program} --runThreadN ${num_of_threads} --runMode genomeGenerate --genomeDir ${index_genome_dir} --genomeFastaFiles !{transformed_fasta}"
